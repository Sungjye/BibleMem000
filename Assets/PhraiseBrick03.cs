...
public class PhraiseBrick03 : MonoBehaviour // @@
{
    public Rigidbody rb;

    public bool isTouched;// = true; // For the initial collision. // 1103
...
// 2020.10.29. Hit 시 크기 변경을 위해서. 1103
    ...
    void Start()
    {
        ...
        cubeRenderer = GameObject.Find("PhraseBrick03").GetComponent<MeshRenderer>();
        cubeRenderer.material.mainTexture = Resources.Load<Texture>("Textures/m2820_3");     // @@  
