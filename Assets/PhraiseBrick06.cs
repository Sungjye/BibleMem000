...
public class PhraiseBrick06 : MonoBehaviour // @@
{
    public Rigidbody rb;
...
// 2020.10.29. Hit 시 크기 변경을 위해서. 1103
    ...
    void Start()
    {
        ...
        cubeRenderer = GameObject.Find("PhraseBrick06").GetComponent<MeshRenderer>();
        cubeRenderer.material.mainTexture = Resources.Load<Texture>("Textures/m2820_6");     // @@  
