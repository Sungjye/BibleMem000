...
public class PhraiseBrick07 : MonoBehaviour // @@
{
    public Rigidbody rb;
...
// 2020.10.29. Hit 시 크기 변경을 위해서. 1103
    ...
    void Start()
    {
        ...
        cubeRenderer = GameObject.Find("PhraseBrick07").GetComponent<MeshRenderer>(); // @@
        cubeRenderer.material.mainTexture = Resources.Load<Texture>("Textures/m2820_7");     // @@  
