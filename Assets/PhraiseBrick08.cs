...
public class PhraiseBrick08 : MonoBehaviour // @@
{
    public Rigidbody rb;
    ...
    void Start()
    {
        ...
        cubeRenderer = GameObject.Find("PhraseBrick08").GetComponent<MeshRenderer>(); // @@
        cubeRenderer.material.mainTexture = Resources.Load<Texture>("Textures/m2820_8");     // @@  
