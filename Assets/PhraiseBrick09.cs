...
public class PhraiseBrick09 : MonoBehaviour // @@
{
    public Rigidbody rb;
    ...
    void Start()
    {
        ...
        cubeRenderer = GameObject.Find("PhraseBrick09").GetComponent<MeshRenderer>(); // @@
        cubeRenderer.material.mainTexture = Resources.Load<Texture>("Textures/m2820_9");     // @@  
