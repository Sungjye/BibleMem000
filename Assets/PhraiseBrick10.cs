...
public class PhraiseBrick10 : MonoBehaviour // @@
{
    public Rigidbody rb;
    ...
    void Start()
    {
        ...
        cubeRenderer = GameObject.Find("PhraseBrick10").GetComponent<MeshRenderer>(); // @@
        cubeRenderer.material.mainTexture = Resources.Load<Texture>("Textures/m2820_10");     // @@  
