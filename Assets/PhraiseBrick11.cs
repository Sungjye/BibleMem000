...
public class PhraiseBrick11 : MonoBehaviour // @@
{
    public Rigidbody rb;
    ...
    void Start()
    {
        ...
        cubeRenderer = GameObject.Find("PhraseBrick11").GetComponent<MeshRenderer>(); // @@
        cubeRenderer.material.mainTexture = Resources.Load<Texture>("Textures/m2820_11");     // @@  
